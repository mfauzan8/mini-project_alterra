...
export const RightNavbar = ({ order, setOrder, deleteById }) => {
                ...
                <Container key={item.id_products} fluid>
                  <div className="d-flex flex-row align-items-center" >
                    ...
                    <div className="col ms-3">
                      ...
                      <h6>
                        <button className="btn-cart me-1"><i className="bi bi-dash"></i></button>
                        <button className="btn-quantity me-1" disabled>{cart.quantity}</button>
                        <button className="btn-cart me-1"><i className="bi bi-plus"></i></button>
                        <button className="btn-cart" style={{ color: "red" }} onClick={() => deleteById(order)}><i className="bi bi-trash3-fill"></i></button>
